...
package java8.nio.file.spi;

import java8.nio.file.*;
import java8.nio.file.attribute.*;
 ...
 * java8.nio.file.Files} class will typically delegate to an instance of this
 * class.
 *
 ...
 * java8.nio.file.spi.DefaultFileSystemProvider} is set. In that case, the
...
public abstract class FileSystemProvider {
     ...
     * java8.nio.file.FileSystem#close closed} it is provider-dependent if the
     ...
     * java8.nio.file.FileSystem#close closed} it is provider-dependent if this
     ...
     * Files#newDirectoryStream(java8.nio.file.Path, java8.nio.file.DirectoryStream.Filter)}
     * method.
     *
     * @param   dir
