...
import static java8.nio.file.attribute.PosixFilePermission.*;
import java.util.*;
...
public final class PosixFilePermissions {
     ...
     * permissions, suitable for passing to the {@link java8.nio.file.Files#createFile
     * createFile} or {@link java8.nio.file.Files#createDirectory createDirectory}
     * methods.
     *
     * @param   perms
     *          the set of permissions
